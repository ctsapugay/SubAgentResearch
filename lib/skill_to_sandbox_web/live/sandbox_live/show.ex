defmodule SkillToSandboxWeb.SandboxLive.Show do
  ...
  def mount(%{"id" => id}, _session, socket) do
    ...
    socket =
      ...
      |> stream(
        ...
        initial_logs
        |> Enum.with_index()
        |> Enum.map(fn {line, i} -> %{id: "log-#{i}", text: line} end)
      )
          ...
          <div class="flex gap-2">
            <button
              ...
              class={[
                ...
                (@status != "running" || @action_in_progress != nil) &&
            ...
            <button
              ...
              class={[
                "btn btn-outline btn-sm border-base-content/15 text-base-content/70 hover:bg-base-content/5 hover:border-base-content/25 transition-all",
                (@status not in ["running", "stopped"] || @action_in_progress != nil) &&
                  "opacity-40 cursor-not-allowed"
              ]}
            >
      ...
      <div class="glass-panel overflow-hidden">
          ...
          <div class="flex items-center gap-3">
            ...
            <%= if @status == "running" do %>
              <span class="inline-flex items-center gap-1 text-[10px] font-medium text-success/70">
                <span class="size-1.5 rounded-full bg-success animate-pulse" /> streaming
              </span>
            <% end %>
          </div>
        </div>
        ...
        >
          ...
          <div
            ...
            id={id}
            class="py-0.5 text-base-content/60 break-all hover:text-base-content/80 hover:bg-base-content/[0.03] -mx-1 px-1 rounded transition-colors"
          >
            {log.text}
          </div>
        </div>
  ...
  defp status_badge_class("stopped"),
    do: "bg-base-content/5 text-base-content/40 border border-base-content/10"
