...
#
#     PHX_SERVER=true bin/skill_to_sandbox start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :skill_to_sandbox, SkillToSandboxWeb.Endpoint, server: true
end
...
config :skill_to_sandbox, :search,
  provider: System.get_env("SEARCH_API_PROVIDER", "tavily"),
  api_key: System.get_env("SEARCH_API_KEY")

# -- Tool Configuration --
config :skill_to_sandbox, :tools,
  cli_timeout_ms: String.to_integer(System.get_env("CLI_TIMEOUT_MS", "30000"))
...
if config_env() == :prod do
  database_path =
    System.get_env("DATABASE_PATH") ||
      ...
      For example: /etc/skill_to_sandbox/skill_to_sandbox.db
      """

  config :skill_to_sandbox, SkillToSandbox.Repo,
  ...
  config :skill_to_sandbox, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :skill_to_sandbox, SkillToSandbox.Mailer,
