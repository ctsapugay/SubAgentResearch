...
1. ..  
   1. Clara \- How to get from skill/subagent to sandbox? (Availability: My ideal timeslot would be anytime between 9:30AM-12PM Mon/Wed/Fri. However, if that does not work I am also available after 6pm on Tues/Wed/Thurs.) [github\_link](https://github.com/ctsapugay/SubAgentResearch)  
   2. Sophia \- How to finetune small models on synthetic traces for tool calling? (ideal time: Tu/Wed/Thu after 5:05pm, Wed 9:30am-10:55 am (except 2/4), Fri 2:35-4 pm)  
   3. Shubham \- How to finetune small models on synthetic traces for tool calling? (ideal time: Mon \- Fri 9 AM-2 pm)  
   4. Berat  \- What benchmarks to choose? \+ a little on what skills/subagents to choose (ideal time: Tu-Fr after 5pm)  
   5. Angela \- What benchmarks to choose? Maybe also on how we can call them to get a better answer (ideal time: Monday or Wednesday morning, and Tuesday anytime)
